with sequential_io; with p_esiut;
use p_esiut;
...
--y compris les cases inutilisables --Tous les éléments de Pieces ont été initialisés à false}
...
--=> {Grillea été mis à jour par lecture dans f dela configurationde numéronb
